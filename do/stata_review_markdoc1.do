...
*** Introduction ***
Some remarks about conventions in stata:

- Can comment several ways:
	- one-line comments with "*" or "//" (note that "*" comments 
	  must be on own line)
	- Block comments with "/* [comments] */"
- Run stata command several ways:
...
* Start up log file
log using `log_name', replace `log_type'
cap qui log c
